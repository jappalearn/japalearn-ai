...
export function calculateScore(answers) {
  ...
  score += expMap[answers.experience] || 0
  ...
  const langMap = {
    ...
    // legacy
    'Not taken': 0, 'Scheduled': 2, 'IELTS <6.0': 4, 'IELTS 6.0–6.5': 10,
    'IELTS 7.0–8.0': 16, 'IELTS 8.0+': 20, 'CELPIP': 16, 'TOEFL': 14,
    'German B1+': 14, 'French B1+': 14,
  }
  score += langMap[answers.language] || 0
  ...
  score += finMap[answers.savings] || 0

  // Segment-specific bonus (up to 10 pts)
