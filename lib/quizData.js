...
export const categoryQuestion = {
  id: 'category',
  question: 'What are you relocating as?',
...
export const subCategoryQuestions = {
  ...
  'Freelancer / Remote Worker': {
    id: 'segment',
    question: 'What type of freelancer or remote worker are you?',
    subtitle: 'Pick the closest match — we cover the full creator economy',
    options: [
      'Creator / Content Creator / Influencer',
      'Digital Marketer / Social Media Manager',
      'Tech Freelancer / Remote Developer',
      'Designer (UI, Graphic, Motion, Brand)',
...
export const segmentSpecificQuestions = {
  ...
  'Product Marketing Manager': [
    {
      id: 'pmm_focus',
      question: 'What type of products have you primarily marketed?',
      options: [
        'B2B SaaS / Enterprise software',
        'Consumer apps / Mobile products',
    ...
    },
    {
      ...
      options: [
        ...
        'Positioning, messaging & competitive analysis',
        'Content marketing & demand generation',
        'Product-led growth (PLG) & onboarding',
        'Sales enablement & customer research',
        'A mix of all of the above',
      ],
    },
    {
      id: 'pmm_portfolio',
      question: 'What is the state of your portfolio or case studies?',
      options: [
        'Strong — published case studies showing measurable impact',
        'Good — internal work I can share on request',
        'Basic — limited documented outcomes',
        'No formal portfolio yet',
      ],
    },
    {
  ...
  'Freelancer / Remote Worker': [
    {
      id: 'freelance_field',
      question: 'What is your primary freelance or creator field?',
      options: [
        'Creator / YouTuber / Podcaster / Influencer',
        'Social media management',
        'Digital marketing / Growth / SEO / Paid ads',
        'Software / Tech development',
        'Design (UI/UX, graphics, motion, brand)',
        'Writing / Content / Copywriting / Editing',
        'Consulting / Strategy / Advisory / Coaching',
    ...
    },
    {
      ...
      options: ['Less than ₦1M', '₦1M – ₦5M', '₦5M – ₦10M', '₦10M – ₦25M', '₦25M+'],
    },
    {
      id: 'international_clients',
      question: 'Do you currently earn from international (non-Nigerian) clients or platforms?',
      options: [
        'Yes — multiple active international clients / brand deals',
        'Yes — one or two',
    ...
    },
    {
      ...
      question: 'Is your freelance or creator work formally registered?',
      options: [
  ...
  'Student (seeking to study abroad)': [
    ...
    {
      id: 'study_goal',
      question: 'What degree do you want and what is your funding model?',
      subtitle: 'This determines both your visa route and your financial requirements',
      options: [
        "Master's Degree (Seeking Full Scholarship)",
        "Master's Degree (Self-Funded / Partial)",
        "Bachelor's Degree (Seeking Scholarship)",
        "Bachelor's Degree (Self-Funded)",
        "PhD / Doctorate (Research Funding)",
    ...
    {
      id: 'cgpa',
      question: 'What is your current or graduated CGPA / Grade?',
      subtitle: 'Crucial for scholarship eligibility and university admission',
      options: [
        'First Class (4.50 - 5.00 / 70%+)',
        'Second Class Upper (3.50 - 4.49 / 60%-69%)',
        'Second Class Lower (2.50 - 3.49)',
        'Third Class / Pass',
        'Still in progress (High High GPA)',
        'Still in progress (Average GPA)',
      ],
    },
  ],
  ...
  'Moving to join family abroad': [
    ...
    },
    {
      ...
      question: 'What is your own professional or employment situation?',
      subtitle: 'Your skills matter even when joining family — some routes let you work too',
      options: [
        'Employed full-time in a skilled profession',
        'Healthcare or education professional',
        'Business owner / self-employed',
        'Currently between jobs / not working',
        'Student',
      ],
    },
  ],
  ...
  'Explorer / Not sure yet': [
    ...
    {
      id: 'explorer_certs',
      question: 'Do you hold any professional certifications or qualifications?',
      subtitle: 'This helps us match you to skilled worker or talent visa routes',
      options: [
        'Yes — internationally recognised certifications (e.g. PMP, CFA, AWS, ACCA)',
        'Yes — Nigerian professional body membership (e.g. ICAN, CIPM, NBA)',
        'Relevant courses / diplomas only',
...
// ── Freelancer sub-type aliases — all use the same questions as 'Freelancer / Remote Worker' ──
;(function () {
  const _fq = segmentSpecificQuestions['Freelancer / Remote Worker']
  segmentSpecificQuestions['Creator / Content Creator / Influencer'] = _fq
  segmentSpecificQuestions['Digital Marketer / Social Media Manager'] = _fq
  segmentSpecificQuestions['Tech Freelancer / Remote Developer']       = _fq
  segmentSpecificQuestions['Designer (UI, Graphic, Motion, Brand)']    = _fq
  segmentSpecificQuestions['Writer / Copywriter / Editor']             = _fq
  segmentSpecificQuestions['Consultant / Coach / Advisor']             = _fq
})()
...
export const universalFollowUps = [
  {
    ...
    subtitle: 'This shapes the length and urgency of your roadmap',
    options: [
      '0–3 months — I need to move very soon',
      '3–6 months — I have some time to prepare',
      '6–12 months — I\'m planning well ahead',
      '12–24 months — I\'m in the early stages',
    ],
  },
  {
    id: 'experience',
  ...
  {
    id: 'savings',
    question: 'How much do you currently have?',
...
const GPA_MAP = {
  'First Class (4.50 - 5.00 / 70%+)': 15,
  'Second Class Upper (3.50 - 4.49 / 60%-69%)': 10,
  'Second Class Lower (2.50 - 3.49)': 4,
  'Third Class / Pass': 0,
  'Still in progress (High High GPA)': 12,
  'Still in progress (Average GPA)': 6,
}
...
export function calculateScore(answers) {
  ...
  score += (GPA_MAP[answers.cgpa] || 0)
  
  // 2. Education Inference Logic (for Students who skip the edu question)
  if (answers.education) {
    score += EDU_MAP[answers.education] || 0
  } else if (answers.study_goal) {
    if (answers.study_goal.includes("Master's")) score += EDU_MAP["Bachelor's"]
    else if (answers.study_goal.includes("PhD")) score += EDU_MAP["Master's"]
    else if (answers.study_goal.includes("Bachelor's")) score += EDU_MAP["High School"]
  }
  
  score += calculateBonus(answers)

  // 3. Killer Criteria & Penalties
  const isHighStakesDest = ['UK', 'Canada', 'Australia', 'USA', 'Ireland'].includes(answers.destination)
  const isScholarshipPath = answers.study_goal?.includes('Scholarship') || answers.study_goal?.includes('Funding')
  const lowSavings = ['Less than ₦1M', '₦1M – ₦5M'].includes(answers.savings)
  const rushTimeline = answers.timeline === '0–3 months — I need to move very soon'

  // Penalty: Low Savings (WALVED for scholarship seekers)
  if (isHighStakesDest && lowSavings && !isScholarshipPath) {
    score -= 15
  }
  
  // Penalty: Low GPA for Scholarship Seekers
  if (isScholarshipPath && (GPA_MAP[answers.cgpa] || 0) < 10) {
    score -= 10
  }

  if (rushTimeline) score -= 10
  if (answers.language === 'IELTS Academic — below 6.0' && isHighStakesDest) score -= 10
...
export function calculateScoreBreakdown(answers) {
  const isScholarship = answers.study_goal?.includes('Scholarship') || answers.study_goal?.includes('Funding')
  ...
  const gpa  = GPA_MAP[answers.cgpa] || 0
  const bonus = calculateBonus(answers)
  
  let edu = EDU_MAP[answers.education] || 0
  if (!answers.education && answers.study_goal) {
     if (answers.study_goal.includes("Master's")) edu = EDU_MAP["Bachelor's"]
     else if (answers.study_goal.includes("PhD")) edu = EDU_MAP["Master's"]
     else if (answers.study_goal.includes("Bachelor's")) edu = EDU_MAP["High School"]
  }
  ...
  if (isScholarship) {
    items.push({ label: 'Academic', score: gpa, max: 15 })
  } else {
    items.push({ label: 'Savings', score: sav, max: 10 })
  }
  
  items.push({ label: 'Profile', score: bonus, max: 10 })
  return items
}
...
function calculateBonus(answers) {
  ...
  else if (answers.licensing_progress === 'Exam passed / licensed in target country') bonus += 6
  else if (answers.licensing_progress?.startsWith('Registered for exam')) bonus += 1
  else if (answers.licensing_progress?.startsWith('Application submitted')) bonus += 1

  // Healthcare: active Nigerian professional registration = strong profile
  if (answers.mdcn_status === 'Active and fully current') bonus += 3
  if (answers.nmcn_status === 'Active and fully current') bonus += 3
  if (answers.pcn_status === 'Active and fully current') bonus += 2
  if (answers.professional_body_status === 'Yes — active registration') bonus += 2
  ...
  // Tech: remote/international work = stronger market positioning
  if (answers.current_work_setup === 'Remote for an international company (working from Nigeria)') bonus += 3
  else if (answers.current_work_setup === 'Startup founder / co-founder') bonus += 2
  else if (answers.current_work_setup === 'Employed full-time in Nigeria') bonus += 1

  // Finance qualifications bonus
  if (answers.finance_quals && !answers.finance_quals.startsWith('None')) bonus += 4

  // Finance: seniority = professional progression
  if (['Manager / Team lead', 'Director / Head of Finance'].includes(answers.finance_seniority)) bonus += 3
  else if (answers.finance_seniority === 'Senior (6–9 years)') bonus += 2
  else if (answers.finance_seniority === 'Mid-level (3–5 years)') bonus += 1

  // HR / Marketing certifications bonus
  if (answers.hrmkt_certs && !answers.hrmkt_certs.includes('No formal certs')) bonus += 3

  // HR/Marketing: seniority = professional progression
  if (['Manager / Head of department', 'Director / VP / C-suite'].includes(answers.hrmkt_seniority)) bonus += 3
  else if (answers.hrmkt_seniority === 'Senior (6–9 years)') bonus += 2
  else if (answers.hrmkt_seniority === 'Mid-level (3–5 years)') bonus += 1

  // Pharmacist additional certifications bonus
  if (answers.additional_certs && answers.additional_certs !== 'None beyond my BPharm/PharmD') bonus += 3

  // Product Marketing Manager portfolio bonus
  if (answers.pmm_portfolio === 'Strong — published case studies showing measurable impact') bonus += 3
  else if (answers.pmm_portfolio === 'Good — internal work I can share on request') bonus += 2

  // Legal: active bar registration = professional standing
  if (answers.nba_status === 'Active member in good standing') bonus += 2
  ...
  if (answers.international_clients === 'Yes — multiple active international clients / brand deals') bonus += 4
  else if (answers.international_clients === 'Yes — multiple active international clients') bonus += 4
  else if (answers.international_clients === 'Yes — one or two') bonus += 2

  // Freelancer: income level
  if (answers.freelance_income === '₦10M – ₦25M' || answers.freelance_income === '₦25M+') bonus += 3
  else if (answers.freelance_income === '₦5M – ₦10M') bonus += 1

  // Freelancer: registered business = stronger visa application
  if (answers.business_registration === 'Yes — registered as a business (CAC)') bonus += 2
  else if (answers.business_registration === 'In progress') bonus += 1

  // Portfolio (product/design)
  if (answers.portfolio_status === 'Strong portfolio — international standard, published online') bonus += 3
  else if (answers.portfolio_status === 'Decent portfolio — needs some work before applying') bonus += 1
  ...
  else if (answers.study_stage === 'Applications submitted') bonus += 2
  else if (answers.study_stage === 'Shortlisted universities') bonus += 1

  // Funding confirmed (student)
  if (answers.funding_status === 'Fully funded — scholarship confirmed') bonus += 4

  // Explorer: professional certifications
  if (answers.explorer_certs?.startsWith('Yes — internationally')) bonus += 4
  else if (answers.explorer_certs?.startsWith('Yes — Nigerian')) bonus += 2
  else if (answers.explorer_certs === 'Relevant courses / diplomas only') bonus += 1

  // Family: applicant employment background
  if (answers.family_employment === 'Employed full-time in a skilled profession' ||
      answers.family_employment === 'Healthcare or education professional') bonus += 3
  else if (answers.family_employment === 'Business owner / self-employed') bonus += 2
...
export function normaliseSegment(segment) {
  ...
  const techRoles = [
    'Software Engineer / Developer', 'Data / AI / Analytics Professional',
    'Product Manager / Designer', 'Product Marketing Manager',
  ]
  ...
  if (freelancerRoles.includes(segment)) return 'Freelancer or Remote Worker'
