...
export const Footer = () => {
  ...
  return (
    <footer className="bg-white">
      ...
      {/* Email subscription - Only on Home Page */}
      {isHomePage && (
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12 md:gap-8">
            <div className="md:col-span-1 border-r-0 md:border-r border-border pr-0 md:pr-8">
              <Link href="/" className="inline-block mb-4">
                <span className="text-2xl font-heading font-bold text-black">JapaLearn <span className="text-primary">AI</span></span>
              </Link>
              <p className="text-sm text-muted-foreground mb-6 leading-relaxed">
                Your trusted migration education platform that provides structured information and e-learning so that you can attract global opportunities.
              </p>
          ...
          <div className="border-t border-border/50 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-xs text-muted-foreground">
              © {new Date().getFullYear()} JapaLearn AI. All rights reserved.
            </p>
            <p className="text-xs text-muted-foreground">
